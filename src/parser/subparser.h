...
void hyConstruct(Proxy &node, const std::string &group, const std::string &remarks, const std::string &server, const std::string &port, const std::string &password, tribool udp, tribool tfo, tribool scv, tribool tls13, const std::string &protocol, const std::string &obfs,const std::string &up, const std::string &down, const std::string &ports, const std::string &dmd)
